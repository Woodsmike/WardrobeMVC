...
namespace WardrobeMVC.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MainOutfitID,OutfitName")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MainOutfitID,OutfitName")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
